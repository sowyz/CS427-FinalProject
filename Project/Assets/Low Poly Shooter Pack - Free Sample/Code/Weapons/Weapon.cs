...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        public override int GetAmmunitionHaving() => ammunitionHaving;
        ...
        public override void FillAmmunition(int amount)
        {
            ...
            int bulletsToFill = Mathf.Min(ammunitionHaving, bulletsNeeded);
            ammunitionHaving -= bulletsToFill;

            //Update the value by a certain amount.
            ammunitionCurrent = Mathf.Clamp(ammunitionCurrent + bulletsToFill, 0, magazineBehaviour.GetAmmunitionTotal());
        }
